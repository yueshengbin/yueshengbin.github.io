...
* 💻 Autonomous Agents: *Designing autonomous agents for interaction with physically grounded environments. Research focuses on retrieval-augmented reasoning, adaptive tool use, and reinforcement learning, to enable agents to navigate knowledge-intensive domains and perform high-level compositional reasoning.*
